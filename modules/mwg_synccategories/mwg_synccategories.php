...
class mwg_synccategories extends Module
{
    ...
    {
        $queries = ['DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'category_map_id`'];
    ...
    private function renderFormCategoryList($data)
    {
        ...
        $cssLink = '<link rel="stylesheet" type="text/css" href="' . _MODULE_DIR_ . 'mwg_synccategories/css/treebox.css">';
        $jsScript = '<script type="text/javascript" src="' . _MODULE_DIR_ . 'mwg_synccategories/js/treebox.js"></script>';
