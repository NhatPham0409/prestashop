...
class mymodule_test extends \Module
{
    public function __construct()
    {
        $this->name = 'mymodule_test';
        $this->tab = 'administration';
        $this->version = '1.0.0';
        $this->author = 'Huy test';
        ...
        $this->displayName = $this->trans('My module Test', [], 'Modules.Mymoduletest.Admin');
        $this->description = $this->trans('Test duplicate config .', [], 'Modules.Mymoduletest.Admin');
    }
    ...
    public function install()
    {
        if (Configuration::get('MYMODULE_NAME') != null) {
            ...
            return (
                parent::install()
                && Configuration::updateValue('MYMODULE_NAME', 'install success')
            );
        }
    }
