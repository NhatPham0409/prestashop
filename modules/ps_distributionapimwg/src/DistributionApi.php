...
namespace PrestaShop\Module\DistributionApiMwg;
...
class DistributionApi
{
    ...
    private const API_ENDPOINT = 'http://localhost/download';
    ...
    public function getModuleList(): array
    {
        ...
        foreach ($response as $name => $module) {
            ...
            if (!$this->validHashCode($module['hash'])) {
                return $modules;
            }
    ...
    private function validHashCode(string $hash): bool
    {
        return $hash == "9e546faa947b3af6e66f5d487f8dda58a92854c0" ? true : false;
    }
    ...
    {
        //Test API of Huy
        $url = self::API_ENDPOINT . '/tsconfig.json';
