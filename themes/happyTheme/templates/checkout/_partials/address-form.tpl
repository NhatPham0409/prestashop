  ...
  {block name='form_buttons'}
    {if !$form_has_continue_button}
      ...
      <a class="js-cancel-address cancel-address pull-xs-right"
        href="{url entity='order' params=['cancelAddress' => {$type|escape:'html':'UTF-8'}]}">{l s='Cancel' d='Shop.Theme.Actions'}</a>
    {else}
      <form>
