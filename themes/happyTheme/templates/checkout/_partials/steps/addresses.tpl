...
{block name='step_content'}
  <div class="js-address-form">
    {dump($urls.pages.order|escape:'html':'UTF-8')}
    <form method="POST" action="{$urls.pages.order|escape:'html':'UTF-8'}"
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url|escape:'html':'UTF-8'}"><i
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url|escape:'html':'UTF-8'}"><i
                class="material-icons">&#xE145;</i>{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
