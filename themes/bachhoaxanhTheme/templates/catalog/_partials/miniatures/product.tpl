            ...
            <a style="position: relative;width: 100%;text-align: center;" id="product_112898"
                ...
                <div
                    ...
                    <img class="img-fluid" alt="Sữa tắm dưỡng sáng Hazeline matcha lựu đỏ 995ml" loading="lazy"
                        src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_85,s_346x346/https://cdn.tgdd.vn/Products/Images/2444/112898/bhx/sua-tam-duong-sang-hazeline-matcha-luu-do-995ml-202403071435567842_300x300.jpg">
                </div>
            </a>
            <div
                ...
                <div style="display: block; line-height: .75rem;">
                    <div
                        ...
                        139.000<sup style="font-size: 12px; position: relative; top: 5px;">₫</sup>
                    </div>
                </div>
                <div class="mb-2px block leading-3">
                    <span
                        style="font-size: 12px;text-decoration-line: line-through; color: color: rgb(157 167 188 /1);line-height: 0px;">265.000₫</span>
                    <span
                        style="font-size: 11px;color: rgb(255 255 255 / 1);line-height: .75rem; font-weight: 700; text-align: center;background-color: rgba(255, 1, 1, .7);border-radius: 2px;margin-left: 3px;padding: 2px;">-30%</span>
                </div>
            </div>
            <button
